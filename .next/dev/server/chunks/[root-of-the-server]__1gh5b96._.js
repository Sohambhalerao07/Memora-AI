...
async function GET(request) {
    try {
        ...
        const tenant = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].getTenantById(tenantId);
        if (!tenant) {
        ...
        const galleries = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].getGalleries(tenantId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            galleries
        });
...
async function POST(request) {
    try {
        ...
        const gallery = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].createGallery(tenantId, {
            name,
            eventDate,
            location,
            description,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1gh5b96._.js.map